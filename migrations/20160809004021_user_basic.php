...
class UserBasic extends Migration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('phone', 'string', array('default' => null, 'length' => 32, 'comment' => '联系方式'));
        $table->addColumn('email', 'string', array('default' => null, 'length' => 255, 'comment' => '邮箱'));
        ...
        $table->addColumn('height', 'string', array('default' => 0, 'length' => 8, 'comment' => '身高(cm)'));
        $table->addColumn('weight', 'string', array('default' => 0, 'length' => 8, 'comment' => '体重(kg)'));
        $table->addColumn('blood', 'string', array('default' => null, 'length' => 4, 'comment' => '血型'));
        $table->addColumn('education', 'string', array('length' => 32, 'default' => '初中','comment' => '文化程度'));
        $table->addColumn('prefession', 'string', array('default' => null, 'length' => 64, 'comment' => '专业'));
        $table->addColumn('marriage', 'integer', array('default' => 0,'comment' => '婚否'));
        $table->addColumn('residence', 'text', array('default' => null, 'comment' => '户口所在地'));
        $table->addColumn('address', 'text', array('default' => null, 'comment' => '家庭住址'));
        $table->addColumn('postcode', 'string', array('default' => null, 'length' => 6, 'comment' => '邮编'));
        $table->addColumn('Idcard', 'string', array('default' => null, 'length' => 32, 'comment' => '身份证'));
        $table->addColumn('professionTitle', 'string', array('default' => null, 'comment' => '职称'));
        $table->addColumn('householdType', 'string', array('length' => 32, 'default' => '农村', 'comment' => '户口性质'));
        $table->addColumn('recordPlace', 'text', array('default' => null, 'comment' => '档案存放地'));
